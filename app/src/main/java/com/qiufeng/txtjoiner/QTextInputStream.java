...
public class QTextInputStream extends FileInputStream{
	...
	public String readFullText(String encoding) throws UnsupportedEncodingException,IOException{
		StringBuilder res=new StringBuilder();
		InputStreamReader isr = new InputStreamReader(new FileInputStream(fileObject),encoding);
		BufferedReader br = new BufferedReader(isr);
		String lineTxt;
		int currentLine=0;
		while ((lineTxt = br.readLine())!=null) {
